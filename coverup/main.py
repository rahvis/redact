...
registry in :mod:`coverup.handlers`; canvas interaction dispatches through
:mod:`coverup.canvas_tools`; background work reports back via
``('-TASK-', ...)`` tuple events (see :mod:`coverup.tasks`).
...
from coverup import __version__, canvas_tools
from coverup.image_container import ImageContainer
from coverup.workfile import WorkfileManager
from coverup.state import AppState
from coverup.handlers import HANDLERS, TOOLBAR_HANDLERS
from coverup.handlers.view import flip_to_page, load_image_to_graph, scale_graph_to_image  # noqa: F401 (re-export)
from coverup.dialogs.common import error_popup, info_popup
from coverup.ui import get_fontpath, create_icons, create_app_icon, create_layout
...
def main():
    ...
    if cli_file_path:
        from coverup.handlers.file import load_path
