"""
File handlers for CoverUP PDF: open, save-redacted, export-page, print, exit.
...
from coverup import __version__, ui
from coverup.document_loader import load_document
from coverup.image_container import ImageContainer, close_all_pages, finalize_pages_chunked
...
def _tool_cursor(state):
    ...
    from coverup.canvas_tools import TOOLS
...
def print_document(window, state):
    ...
    fd, tmp_path = tempfile.mkstemp(prefix='coverup_print_', suffix='.pdf')
    os.close(fd)
